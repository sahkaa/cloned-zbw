...
exec java ${MANDATORY_JAVA_OPTS} ${JAVA_OPTS} -Dorg.eclipse.jetty.server.Request.maxFormContentSize=5000000 -jar /usr/src/cloned-zbw/service/cloned-zbw-api/build/libs/cloned-zbw-api.jar
